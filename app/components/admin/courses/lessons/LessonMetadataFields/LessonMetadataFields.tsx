...
import type { LessonMetadataFormValues } from '../../../../../../lib/courses/validators/admin-lesson-metadata-fields'
import Input from '../../../../ui/Input/Input'
import TextArea from '../../../../ui/TextArea/TextArea'
import styles from '../../CreateCourseForm/CreateCourseForm.module.scss'

type LessonMetadataFieldsProps = {
  values?: LessonMetadataFormValues
  getFieldError: (field: string) => string | undefined
  isPending: boolean
}

export default function LessonMetadataFields({
  values,
  getFieldError,
  isPending,
}: LessonMetadataFieldsProps) {
